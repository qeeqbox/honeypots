...
def test_ipp_server(server_logs):
    ...
    assert query["data"] == {
        "request": (
            "VERSION 2.0|REQUEST 0x12f70|OPERATION Get-Printer-Attributes|GROUP operation-attributes-tag|"
            "ATTR attributes-charset utf-8|ATTR attributes-natural-language en|ATTR printer-uri ipp://127.0.0.1:631/D"
        )
    }
